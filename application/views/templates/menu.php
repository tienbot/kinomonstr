        ...
        <div class="col-lg-3 col-lg-pull-9"> <!-- Меняем блоки местами col-lg-pull-9 -->
          ...
          <div class="panel panel-info hidden-xs">
            ...
            <div class="panel-body">
              <form role="search" action="/kinomonstr/index.php/search/" method="get">
          ...
          <div class="panel panel-info">
            ...
            <div class="panel-body">
              ...
              <form role="form" action="/kinomonstr/index.php/auth/login/" method="post">
                <div class="form-group">
              ...
              <a href="/kinomonstr/index.php/auth/logout" class="btn btn-warning pull-right">выход</a>
          ...
          <div class="panel panel-info">
            ...
            <div class="panel-body">
              ...
              <?php foreach ($news as $key => $value): ?>
                  <p><a href="/kinomonstr/index.php/news/view/<?php echo $value['slug']; ?>"><?php echo $value['title']; ?></a></p>
              <?php endforeach ?>
                ...
                <ul class="list-group">
                  ...
                  <?php foreach ($films as $key => $value): ?>
                    <li class="list-group-item list-group-warning">
                      ...
                      <a href="/kinomonstr/index.php/movies/view/<?php echo $value['slug']; ?>/"><?php echo $value['name']; ?></a>
                    </li>
                  <?php endforeach ?>
